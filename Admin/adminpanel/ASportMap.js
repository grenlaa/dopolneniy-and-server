...
import { createMap,editMap } from "../../Requests/R_Map";
...
const ASportMap = () => {
    ...
    async function click() {
       { change ?
        editMap("http://localhost:8081/api/EditSportMap/",id,title,descr,number,site,url,cord[0],cord[1]):
        createMap("http://localhost:8081/api/CreateSportMap",title,descr,number,site,url,cord[0],cord[1]);}
    ...
    async function Del(id) {
        r_delete("http://localhost:8081/api/DelSportMap/"+id)
        setCreate(false)
        setChange(false)
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main class="ms-sm-auto px-md-4">
                    <h1 className="row justify-content-md-center">Карта спортивных учреждений</h1>
