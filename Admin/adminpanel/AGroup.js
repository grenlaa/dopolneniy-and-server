...
const AGroup = () => {
    ...
    async function click() {
        {
            change ?
                editGrBr("http://localhost:8081/api/EditGroup/", id, title, image, url) :
                createGrBr("http://localhost:8081/api/CreateGroup", title, image, url);
        }
    ...
    async function Del(id) {
        ...
        r_delete("http://localhost:8081/api/DelGroup/" + id)
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main class=" ms-sm-auto  px-md-4">
                    <h1 className="row justify-content-md-center">Зож Группы</h1>
