...
import "../../styles/recipe_card.scss"

export default function RecipeCard(props) {
    const [currentTab, setCurrentTab] = useState("");

    const changeTab = (event, recipe) => {
    ...
    return (
        <div className="h-100">
            <div className="recipe-card h-100">
                <img src={props.image} className="recipe-card-img"></img>

                <div className="recipe-card-title">
                    <h4>{props.point.title}</h4>
                </div>

                <ul className="d-flex flex-wrap recipe-card-tab">
                    <li>
                        <a
                            href="#"
                            className="tablinks"
                            onClick={(e) => changeTab(e, "ingredients")}
                        >
                            <svg
                                className="recipe-tab-img"
                                version="1.1"
                                id="Layer_1"
    ...
    c-1.3-0.8-2.7-1.6-4-2.4c-0.1,0-0.3-0.1-0.3,0c-0.8,0.8-1.6,1.5-2.5,2.4C26,24.1,28.2,24.1,30.5,24.1z"
                    ...
                    <li>
                        <a
                            href="#"
                            className="tablinks"
                            onClick={(e) => changeTab(e, "directions")}
                        >
                            <svg
                                version="1.1"
                                id="Layer_2"
    ...
    c1.6,2,3.3,3.9,4.9,5.9c0.4,0.5,0.9,1.1,1.3,1.6c0.3,0.3,0.2,0.6-0.1,0.8c-1.8,1.2-3.7,2-5.9,2.1C25.6,36,25.3,36,25,36z"
                    ...
                    <li>
                        <a
                            href="#"
                            className="tablinks"
                            onClick={(e) => changeTab(e, "nutrition")}
                        >
                            <svg
                                version="1.1"
                                id="Layer_5"
    ...
    c0,1.7,0,3.4,0,5.1c0,1.4,0,2.8,0,4.2c0,0.3,0,0.4-0.3,0.4c-2,0-4,0-6,0C13.1,36,13,36,12.9,36z"
                ...
                {currentTab == "serving" && (
                    <div id="serving" className="tabcontent">
                        <h3>Порции</h3>
                        <p>
                        {props.point.portion}</p>
                    </div>
                )}

                {currentTab == "nutrition" && (
                    <div id="nutrition" className="tabcontent">
                        <h3>Пищевая ценность</h3>
                       
                        <ul>
                            
                        {props.point.nutrValue}
                        </ul>
                    </div>
                )}
            </div>
